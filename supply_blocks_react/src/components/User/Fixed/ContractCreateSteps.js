    ...
    return(<React.Fragment>
        {isStarted ? <Steps>
            ...
            <Step status={getStatus("Uploading to IPFS")} title="Uploading to IPFS" icon={
                getStatus("Generating Keys") === "process" ? <LoadingOutlined /> : <CloudUploadOutlined /> 
            } />
            <Step status={getStatus("Creating Smart Contract")} title="Creating Smart Contract" icon={
                getStatus("Generating Keys") === "process" ? <LoadingOutlined /> : <SolutionOutlined />
            } />
            <Step status={getStatus("Completed")} title="Completed" icon={
                getStatus("Generating Keys") === "process" ? <LoadingOutlined /> : <CheckCircleTwoTone />
            } />
        </Steps> : <div></div>}
